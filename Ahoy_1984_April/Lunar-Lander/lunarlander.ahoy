...
10 PRINT"{SC}{WH}{CD}{CD}{CD}{CD}             LUNAR LANDER"
20 PRINT"{CD}          (C) COPYRIGHT 1983"
...
215 IF P=7OR(JAND4)=0THENH=H-1:PRINT"{HM}{CD}{CR}<<":FU=FU-1
216 IF P=2OR(JAND8)=0THENH=H+1:PRINT"{HM}{CD}{CR}>>":FU=FU-1
...
400 POKES+4,0:GOSUB750:PRINT"{HM} LANDED!!"
410 GETA$:IFA$<>"{F7}"THEN410
415 POKEV+21,0:PRINT"{HM}       "
420 IFFU=0THEN 460
...
460 PRINT"{SC}":PRINT:PRINT"DO YOU WANT TO PLAY AGAIN?"
470 GETA$:IFA$=""THEN470
480 IFA$="Y"THEN139
490 IFA$<>"N"THEN470
500 POKES+4,0:PRINT"{SC}":END
700 PRINT:PRINT:PRINT"  ENTER GRAVITY STRENGTH ({RV}1{RO},{RV}2{RO}, OR {RV}3{RO})"
...
740 GOTO710
750 PRINT"{HM}{CR}{CR}{CR}{CR}{CR}{CR}{CR}{CR}{CR}{CR}{CR}{CR}{CR}{CR}{CR}{CR}{CR}SCORE";SC;
760 PRINT"{HM}{CD}{CR}  {HM}";TAB(28);"FUEL     {CL}{CL}{CL}{CL}{CL}";FU;:RETURN
...
900 PRINT"{SC}":GOSUB750:PRINT:FORY=0TO9:A=RND(0)
910 IFA>.3THENPRINTTAB(RND(0)*39);"."
920 IF A<=.3THENPRINT
930 NEXT:PRINT:PRINT:PRINT
1000 PRINT"                              {RV}{s EP}{c *}{RO}       "
...
1900 PRINT"{RV}{s EP}         {c *}{RO}   {RV}{s EP}                        {RO}"
1910 PRINT"{RV}           100                         {RO}";
1920 IFL2=1ANDL1=1THENPRINT"{HM}{CD}{CD}{CD}{CD}{CD}{CD}{CD}{CD}{CD}{CD}{CD}{CD}{CD}{CD}{CD}{CD}{CD}{CD}{CD}{CD}{CD}{CD}{CD}{CD}{CR}{CR}{CR}{CR}{CR}{CR}{CR}{CR}{CR}{CR}{RV}{c *}{RO}   {RV}{s EP}{RO}";
1930 RETURN
...
4999 REM DRAW CAVE
5000 PRINT"{SC}":GOSUB750:PRINT:POKES+4,0:POKES+1,2
5005 PRINT"     {RV}                                  "
5010 PRINT"     {RV}                                  "
5020 PRINT"     {RV}                                  "
5030 PRINT"     {RV}                                  "
5040 PRINT"     {RV}                                  "
5050 PRINT"     {RV}                  {RO}{s EP}  {c *}{RV}  {RO}{s EP}  {c *}{RV}  "
5060 PRINT"     {RV}                  {RO}               "
5065 PRINT"     {RV}                  {RO}               "
5070 PRINT"     {RV}                  {RO}               "

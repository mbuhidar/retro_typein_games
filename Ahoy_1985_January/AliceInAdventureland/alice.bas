...
2530 P=RND(0):IFP<.7THENPOKEG2+GS,32:GS=GS-ABS(GS<>0):GOSUB2640
2532 IFP<.7THENPRINTSP$"YOU LOST A GOLD COIN!":FORI=1TO700:NEXT
2535 AX=PX(5):AY=PY(5):PRINTER$
2540 GOSUB1300:S3=S(3):S(3)=0:S(3)=0:S7=S(7):S(7)=0
2545 GOSUB1100:S(3)=S3:S(7)=S7:GOSUB1200:RETURN
2550 FORU=ZTOZ-1STEP-.2:POKESE+4,33

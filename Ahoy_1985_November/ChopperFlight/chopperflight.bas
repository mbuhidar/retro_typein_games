...
350 GOSUB6:PRINTCR$:GOSUB6:PRINTSP$:GOSUB6:PRINTED$:GOSUB6
352 PRINTTAB(10)"[WHITE]PRESS TRIGGER TO PLAY"
354 B=PEEK(JL)AND16:IFB=0THENRETURN
356 GOTO354
358 REM FINAL SCORE
360 POKEBC,0:FS=100*MS*SL+(500-ZZ):TS=(40-(14+MS))/2
362 IFMS=0THENPRINT"[CLEAR]":PRINTTAB(13)"[PURPLE]NO MEN RESCUED[WHITE]":GOTO370
364 PRINT"[CLEAR][WHITE]":PRINTTAB(TS)"MEN RESCUED:  ";:FORMR=1TOMS:PRINT"[c 1][s X]";:NEXT:PRINT
366 PRINTTAB(14)"[WHITE]BONUS:  ";:FORHH=1TOMS:O=O+100:POKEH1,100:FORM=1TO150:NEXT
368 POKEH1,0:PRINT"[HOME][DOWN][DOWN]"TAB(21)O;:NEXT:PRINT
370 PRINTTAB(11)"[8"[DOWN]"]YOUR SCORE:  "FS"[DOWN]"
